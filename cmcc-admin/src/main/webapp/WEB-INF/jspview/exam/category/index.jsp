...
<body >
                            ...
                            <div class="col-sm-12 b-r">
		                           ...
		                           <input name='id' type="hidden"/>
		                           	<table class='table table-bordered'>
		                           		<thead>
		                           		<tr style="text-align: center;" ><td colspan="6" ><h3>题库分类管理</h3></td></tr>
		                           		</thead>
		                           		<tbody>
   ...
   <script>
    ...
    function submit_form(){
    	$.ajax({
    		   type: "POST",
    		   url:  $.common.getContextPath() + "/exam/category/save",
    		   data: $("form").serialize(),
    ...
    function fun_delete(id){
    	...
    	layer.confirm('确定删除当前员工？', {
    		  btn: ['确定','取消'] //按钮
    			...
    			$.ajax({
    		 		   url:  $.common.getContextPath() + "/exam/category/delete?id="+id,
    		 		   success: function(msg){
    		 		     if(msg.code==1){
    		 		    	 toastr.success('操作成功');
    		 		    	 table.draw();
    	  ...
    	  $("#_new").click(function(){
        	...
        	table=$('#dt_table_view').DataTable( {
        		"dom": "rt<'row'<'col-sm-5'i><'col-sm-7'p>>",
        		  "ordering": true,
	            "ajax": {
	                "url":  $.common.getContextPath() + "/exam/category/list",
	                "type": "POST",
	                "dataSrc": "datas"
	              },
				"columns" : [{
